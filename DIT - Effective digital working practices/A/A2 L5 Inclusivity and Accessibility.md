...
### How technology can support inclusion and accessibility
- Interface design, accessibility features, and flexible work hours and locations can make participation easier.
- A video may use subtitles and sign language; a website may provide alt text for screen readers.
...
- Cloud computing and file sharing make files available across devices with an internet connection.
- Mobile devices and internet access let people work on the go.
- Project management software lets teams assign, track, and complete tasks online.
