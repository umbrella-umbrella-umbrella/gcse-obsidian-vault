...
- It can exhaust CPU, RAM, or bandwidth, flood servers, and cause services to crash.
- A **Distributed Denial of Service (DDoS)** attack sends traffic from many devices at once, often controlled through a botnet.

### Reducing risk
- Firewalls monitor and control traffic entering and leaving a device or network.
- Access rights and permissions can limit exposed services.
- Anti-virus and malware protection can help prevent botnet infections.
- Secure backups can help recovery after disruption.
- Usernames and passwords help prevent unauthorised access to servers.
- Firewalls can reduce the attack surface by allowing only necessary ports and services. They can help against DoS attacks to some extent and work alongside other security tools.
