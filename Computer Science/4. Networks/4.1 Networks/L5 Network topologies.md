# L5 Network topologies

**Pearson Edexcel GCSE Computer Science (1CP2) — specification 4.1.8.**
...
Do you know where the servers are?
Can you spot any network hardware in this room?

### Network topologies

Organising a network
The way that a LAN is organised is known as its topology.
There are three topologies commonly used in LANs:
- Bus
- Star
...
recipient.
Mesh topology
Reasonably secure as the traffic takes the shortest route to its
destination.
...
topologies.
✔ Draw and label a diagram of each topology.
✔ Match descriptions to network topologies.
✔ Recognise the role of components that make up the internet
(backbone, POP, NAP, router).

---

**Source PDFs:** `4. Networks/L5 Network topologies.pdf`.
