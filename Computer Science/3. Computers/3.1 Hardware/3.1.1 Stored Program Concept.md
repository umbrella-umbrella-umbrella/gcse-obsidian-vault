	...
	- ## **Fetch, Decode, Execute (FDE)**
		...
		- **Buses:**
		    ...
		    - _Data Bus_
		        ...
		        -  (e.g) an instruction from RAM that is being transferred to the CPU.
		        - Bidirectional
		    - _Address Bus_
		        - Carries the address of a memory location
		        - (e.g) the address of an instruction being fetched from memory
		        - Unidirectional
		    - _Control Bus_
		        - Carries signals that control the CPU components
		        - (e.g) a signal to start fetching the next instruction
		        - Bidirectional
